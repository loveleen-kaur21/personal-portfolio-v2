export default function Skills() {
    const skillCategories = [
        ...
        },
        {
            ...
            skills: ["Java", "Python", "Ruby", "Django", "Spring", "JavaServer Pages (JSP)", "RESTful APIs", "SOAP", "Node.js", "Microservices"]
        },
        {
        ...
        },
        {
            ...
            skills: ["Git", "GitHub", "Docker", "Jenkins", "Microsoft 365", "Kubernetes", "Postman"]
        }
    ];

    return (
        <div className="min-h-screen flex items-center justify-center p-12 md:p-24" style={{minHeight: 'calc(100vh - 80px)'}}>
